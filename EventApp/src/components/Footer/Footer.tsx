      ...
      <div className='bg-blueFooterOne'>
        <div className='container'>
          <div className='pt-16 md:pt-20'>
            <div className='px-8 sm:px-16 md:px-32 xl:px-52'>
              <div className='logo mb-2 ml-auto mr-auto block h-[30%] w-[30%]'>
                <img src={logo} alt='logo' className=' h-full w-full object-cover' />
              </div>
              <div className='grid grid-cols-3 items-center text-center leading-loose sm:flex sm:justify-between'>
                <Link
                  to={path.home}
                  className='text-sm font-semibold uppercase tracking-wide text-white md:font-bold md:tracking-widest '
                >
                  Home
                </Link>
                <Link
              ...
              <div className='py-6'>
                <div className='flex items-center justify-center'>
                  <div className='mr-4 fill-white/90'>
                    <svg xmlns='http://www.w3.org/2000/svg' height='1em' viewBox='0 0 320 512' className='h-6 w-6'>
                      <path d='M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z' />
                    </svg>
                  </div>
                  <div className='fill-white/90'>
                    <svg xmlns='http://www.w3.org/2000/svg' height='1em' viewBox='0 0 448 512' className='h-6 w-6'>
                  ...
                  <div className='ml-4 fill-white/90'>
