...
type Props = {
  ...
  setImageCurrentIndex: React.Dispatch<React.SetStateAction<number>>
}
export default function CarouselImage({ listImageDetail, imageCurrentIndex, setImageCurrentIndex }: Props) {
              ...
              <button onClick={() => handleChangeImage(index)}>
                <img
                  ...
                  className={`h-[84px] w-[120px] rounded-md border-2 border-white object-cover transition-all duration-300 ${
                    index === imageCurrentIndex ? 'border-red-700' : ''
